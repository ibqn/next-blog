        ...
        <div className="z-10 flex w-3/4 flex-col items-start justify-center p-16 text-light">
          ...
          <Link href={`/blog/${slug}`} className="mt-6">
            <h1 className="text-4xl font-bold capitalize">
              <span className="bg-linear-to-r from-accent to-accent bg-size-[0px_6px] bg-bottom-left bg-no-repeat transition-[background-size] duration-500 hover:bg-size-[100%_6px]">
                {title}
              </span>
            </h1>
          </Link>
