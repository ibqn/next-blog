...
export const Logo = () => {
  return (
    <Link href="/" className="text-dark dark:text-light flex items-center gap-4">
      <div className="border-dark dark:border-light w-16 overflow-hidden rounded-full border border-solid">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" role="img" className="h-auto w-full rounded-full">
          <defs>
            <clipPath id="a-506">
              <circle
                cx="320"
